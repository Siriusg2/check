...
BinarySearchTree.prototype.obtenerPrendas = function (string) {
  ...
  if (this.value.nombre === string) arr.push(this.value.nombre);

  if (this.left) arr = arr.concat(this.left.obtenerPrendas(string))
  if (this.right) arr = arr.concat(this.right.obtenerPrendas(string))
  return arr
