...
//  Para esto deberás agregar al prototype de LinkedList el método 📦 migrarStock() 📦, el cual 
//deberá retornar todos los valores almacenados
...
let current = this.head;
  ...
  const my = {}
    while (current){
      ...
      my[current.value.nombre] = current.value.stock
