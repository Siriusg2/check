...
// 
// Un cliente ha solicitado pantalones de una talla determinada. Es necesario ir a buscar al inventario los
// pantalones y obtener
...
function apilarPantalones(array, talla) {
  ...
  if (array[i]!== talla)pantalonesRestantes.push(array[i])
  
    
  }
  
  my.pantalonesEncontrados = pantalonesEncontrados
  my.pantalonesRestantes = pantalonesRestantes
    return my
  }
